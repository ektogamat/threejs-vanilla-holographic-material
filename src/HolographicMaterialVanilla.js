 ...
 * -- Edited by Brendan Sting - Dec 2023. --
 */
import {
    ShaderMaterial,
    Clock,
    ...
    constructor(parameters = {}) {
      ...
      this.uniforms = {
        ...
        hologramBrightness: new Uniform(
          (parameters.hologramBrightness !== undefined) ? parameters.hologramBrightness : 1.0,
        ),
        ...
        hologramColor: new Uniform(
          (parameters.hologramColor !== undefined) ? new Color(parameters.hologramColor) : new Color("#00d5ff"),
        ),
        ...
        hologramOpacity: new Uniform(
          (parameters.hologramOpacity !== undefined) ? parameters.hologramOpacity : 1.0,
        ),
      };
      ...
      this.blending = (parameters.blendMode !== undefined) ? parameters.blendMode : NormalBlending;
